...
@interface BaseViewController ()<BBBaseViewControllerDelegate,BBBaseViewControllerDataSource,UIGestureRecognizerDelegate>
{
    CGFloat navigationY;
    CGFloat navBarY;
    CGFloat verticalY;
...
{
    [super viewDidLoad];
//    /* 将没有navigation的vc的状态栏有而变为全局淡蓝色*/
//    UIView*barView=[[UIView alloc]initWithFrame:CGRectMake(0, 0, kWindowW, 20)];
//    barView.backgroundColor=KMainColor;
